...
if ( ! class_exists( 'adxp_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since ADXP 1.0
	 */
	class adxp_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'adxp' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'adxp' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'adxp' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'adxp' ),
						'full'    => esc_html__( 'Full text', 'adxp' ),
					),
				)
			);
			...
			$wp_customize->register_control_type( 'adxp_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new adxp_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'adxp' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
