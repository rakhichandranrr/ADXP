/* global adxpIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'adxp-supports-dark-theme' ) ) {
	adxpDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function adxpDarkModeEditorInit( attempt ) {
	...
	if ( adxpIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						adxpDarkModeEditorInit( attempt + 1 );
					},
