...
<section class="Client-results common-padd bg-light" id="Results">
 ...
 ?>
          ...
          <div class="cd-re">  
          <span class="designation tags-list"><?php echo get_insight_tags($client_results_res->ID); ?></span>
          <h4 class="mb-3 mt-4"><a href="<?php echo get_permalink($client_results_res->ID); ?>"><?php echo $client_results_res->post_title; ?></a></h4>
          <span  class="upper-heading client-date"><?php echo date('F d, Y', strtotime($client_results_res->post_date)); ?></span>
           </div>
          </div>
      </div>
      <?php
...
?>
<section class="peoples  common-padd" id="People">
  <div class="container">
