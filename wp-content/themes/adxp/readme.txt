...
ADXP is a blank canvas for your ideas and it makes the block editor your best brush.
...
Take it for a spin! See how ADXP elevates your portfolio, business website, or personal blog.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in ADXP in the search form and press the 'Enter' key on your keyboard.
...
== Privacy ==
ADXP uses LocalStorage to save the setting when Dark Mode support is turned on or off.
...
ADXP WordPress Theme, 2020-2023 WordPress.org
ADXP is distributed under the terms of the GNU GPL.
...
ADXP is derived from Seedlet, (C) 2020 Automattic, Inc.

ADXP is also based on:
