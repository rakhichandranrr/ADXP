    ...
    <div class="row">
      ...
      <div class="banner-content d-flex flex-column align-items-center justify-content-center extra-padd">
        ...
        <div class="flex-column" >
          ...
          <h1 class="search-hd main-tittle ins-tittle  mb-3 text-light mt-4" >Results for
...
<section class="bg-light job section-apply">
...
<section class="bg-light common-padd search-result-list  pdl-1 pdr-1">
  ...
  <div class="container">
    ...
    <div class="row">
     ...
     <a href="<?php echo get_permalink($post_id); ?>"> <div class="col-lg-12">
 ...
 ?>
    ...
    echo esc_html($postType->labels->singular_name);
            ...
            <h2 class="mt-2 mb-2"> <a href="<?php echo get_permalink($post_id); ?>"><?php echo $post->post_title;?></a></h2>
