...
<section class="Values common-padd">
  <div class="container">
    <div class="row pdl-1 pdr-1">
      <h3 class="inner-heading text-light mb-4"><?php echo $our_values['our_values_title']; ?></h3>
...
<section class="common-padd why-us">
  <div class="container">
    <div class="row pdl-1 pdr-1">
      ...
      <?php
      $why_us_sub = $why_us['why_us_sub_items'];
      if ($why_us_sub) {
        foreach ($why_us_sub as $why_us_sub_res) {
      ?>
          <div class="col-lg-6">
            <h5 class="text-light"><?php echo $why_us_sub_res['why_us_sub_title']; ?></h5>
            <div class="paragraph"> <?php echo $why_us_sub_res['why_us_sub_content']; ?> </div>
          </div>
      <?php
        }
      }
...
?>
  <section class="peoples common-padd">
    <div class="container">
      <div class="row pdl-1 pdr-1">
        <div class="col-lg-12">
          <h3 class="inner-heading text-light mb-4"> <?php echo get_field('leadership_team_heading'); ?></h3>
        </div>
