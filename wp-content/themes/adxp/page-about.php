...
<section class="abt-adxp common-padd">
  <div class="container">
    ...
    <dotlottie-player src="<?php echo get_template_directory_uri(); ?>/assets/animation/ADXP_WebOption.json" background="transparent" speed="1" style="width: 600px; height: 360px;" loop autoplay></dotlottie-player>
