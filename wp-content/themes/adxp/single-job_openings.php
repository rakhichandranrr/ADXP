        ...
        <section class="common-padd bg-light Applyjob pdl-1 pdr-1 pt-0" id="Applyjob">
         <div class="container">
            ...
            <div class="row custom-grid-mobile">
                <div class="col-lg-12">
                    <h3 class="inner-heading mb-4" >Apply for this role</h3>
                    <div class="paragraph">
                        Lorem ipsum dolor sit amet consectetur. Et velit integer scelerisque nisl accumsan. Duis nunc cras orci integer molestie 
                    </div>
                </div>
            </div>
             <div class="row">
